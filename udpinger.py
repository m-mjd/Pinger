...
while True:
    try:
        ...
        message = input(Fore.WHITE + ": پیام مورد نظر را برای ارسال وارد کنید : \n" + Style.RESET_ALL).encode()
    ...
    for i in range(number):
        ...
        try:
            ...
            print(Fore.RED + "عدم پاسخگویی میزبان" + Style.RESET_ALL)
...
{Fore.BLUE}{avg_time:.5f} s{Style.RESET_ALL}""")
    ...
    addr_info = socket.getaddrinfo(hostname, port, socket.AF_INET, socket.SOCK_DGRAM)
